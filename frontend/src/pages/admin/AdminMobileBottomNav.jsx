...
function AdminMobileBottomNav({ activeTab, setActiveTab, onLogout }) {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-neutral-dark/5 px-4 pb-6 pt-3 z-50 flex items-center justify-between shadow-[0_-4px_20px_rgba(0,0,0,0.03)] rounded-t-[32px]">
      {menuItems.map((item) => {
